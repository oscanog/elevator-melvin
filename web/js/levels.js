...
export const LEVELS = [
  ...
  },
  {
    ...
    testPersons: [
      { name: 'Ava', pickup: 0, dropoff: 8 },
      { name: 'Ben', pickup: 2, dropoff: 6 },
      { name: 'Cara', pickup: 4, dropoff: 1 },
      { name: 'Drew', pickup: 7, dropoff: 3 },
      { name: 'Eli', pickup: 1, dropoff: 9 },
      { name: 'Faye', pickup: 5, dropoff: 0 },
      { name: 'Gus', pickup: 8, dropoff: 2 },
      { name: 'Hana', pickup: 3, dropoff: 7 },
      { name: 'Ivan', pickup: 6, dropoff: 4 },
    ],
  },
  {
    id: 9,
